...
All threads are indexed as one-dimensional vectors even in a multidimensional space, as shown in Figure~\ref{fig:threadsnblocks} \jrs{FIGURE = GRID WITH BLOCKS WITH THREAD WITH IDS IN 2D, TRY TO SHOW MEMORY AS WELL?}.
