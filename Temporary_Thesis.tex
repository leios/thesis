...
\input{MainText/split_op}
\input{MainText/1d}
\input{MainText/gpue}
\input{MainText/2d}
\input{MainText/vortex_states}
...
\includepdf[pages=-, offset=0.54cm \voffset]{./Images/papers/PRF_VORTEX.pdf} % Includes pdf
